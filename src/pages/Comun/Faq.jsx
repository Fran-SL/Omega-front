  ...
  useEffect(() => {
    const fetchFAQData = async () => {
      ...
      try {
        ...
        if (!response.ok) throw new Error('Error al obtener las preguntas frecuentes');
            ...
            {faqData.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  {activeIndex === index ? <FaAngleUp className="text-gray-500" /> : <FaAngleDown className="text-gray-500" />}
                </div>
                <AnimatePresence>
                  {activeIndex === index && (
                    <motion.p
